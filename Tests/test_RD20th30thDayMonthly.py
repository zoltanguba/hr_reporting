...
from ReportingSourceCode.ReportDefinitions.RD20th30thDayMonthly import RD20th30thDayMonthly as ReportDefToTest
...
class TestRD20th30thDayMonthly(unittest.TestCase):
