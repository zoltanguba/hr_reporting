...
from ReportingSourceCode.ReportDefinitions.RD11th19thDayMonthly import RD11th19thDayMonthly as ReportDefToTest
...
class TestRD11th19thDayMonthly(unittest.TestCase):
