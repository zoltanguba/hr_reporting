...
from ReportingSourceCode.ReportDefinitions.RDLastWDayMonthly import RDLastWDayMonthly as ReportDefToTest
...
class TestRDRDLastWDayMonthly(unittest.TestCase):
